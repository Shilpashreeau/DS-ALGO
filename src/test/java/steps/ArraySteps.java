...
public class ArraySteps {
	...
	@When("The user clicks {string} in List\" button")
	public void the_user_clicks_in_list_button(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	@Then("The user should be redirected to {string} page contains a question,a tryEditor with Run and Submit buttons")
	public void the_user_should_be_redirected_to_page_contains_a_question_a_try_editor_with_run_and_submit_buttons(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Then("The user should be redirected to {string} page contains questions,a tryEditor  to write code with Run and Submit buttons")
	public void the_user_should_be_redirected_to_page_contains_questions_a_try_editor_to_write_code_with_run_and_submit_buttons(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
